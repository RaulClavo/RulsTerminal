...
class Terminal:
    def __init__(self):
        ...
        self.board = [[' ', ' ', ' '], [' ', ' ', ' '], [' ', ' ', ' ']]
    def commands(self):
        global pos1, pos2, tictactoe, WHITE, BLACK
        if pygame.key.get_pressed() == pygame.K_RETURN:
            while pos1 != pos2 and pygame.key.get_pressed() != pygame.K_UP and pygame.key.get_pressed() != pygame.K_DOWN: pos1, self.text = pos1 + 1, []
            ...
            if self.input_text == "tictactoe":
                tictactoe = 1
                self.text.append("TicTacToe Generado")
            ...
            if self.input_text == "exit":
                pygame.quit()
                sys.exit()
            if self.input_text == "help exit": self.text.append("El comando 'exit' sirve para cerrar el terminal.")
    ...
    def tictactoe(self):
        global current_player, tictactoe, winner
        for i in range(1, 3):
        ...
        if pygame.mouse.get_pressed() and tictactoe:
